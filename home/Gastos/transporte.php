			...
			<div id="wrapper">
				...
				<!-- Main -->
					<section id="main">
						<header>
							<div>
							<span class="flecha"> <h1> <img src="images/flecha.png" alt="" width="30px" height="30px" /> Transporte</h1>
							</span>
						</div>
						</header>
						<br>
						  ...
						  <form>
							<div class="form-group">
							  <label for="banco">Número de gasto</label>
							  <input type="texto" class="form-control" id="banco" 
									 aria-describedby="Ingresa tu gasto" placeholder="Ingresa tu gasto">
							</div>
							  ...
							  <div class="form-group">
								<label for="fecha">Fecha de pago de transporte</label>
